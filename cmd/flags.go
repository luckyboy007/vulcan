...
const (
	...
	flagCassandraRetryReset    = "cassandra-retry-reset"
	flagCassandraRetryWait     = "cassandra-retry-wait"
	flagCassandraRetryTimes    = "cassandra-retry-times"
	flagESAddrs                = "es"
	...
	flagDownsamplerCleanupRate = "cleanup-rate"
)
